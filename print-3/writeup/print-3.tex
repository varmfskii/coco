...
\lstinputlisting[language={[Motorola6809]Assembler}]{../code/allram.asm}

Then perform the actual patches.

\lstinputlisting[language={[Motorola6809]Assembler}]{../code/print0.asm}
...
\lstinputlisting[language={[Motorola6809]Assembler}]{../code/vector1.asm}
...
\lstinputlisting[language={[Motorola6809]Assembler}]{../code/vector2.asm}

\section{Console out}
Vector RVEC3 takes the output character in register A and prints it to
the selected device.

\lstinputlisting[language={[Motorola6809]Assembler}]{../code/vector3.asm}
